  ...
  return (
      <div className={styles.wrapperTwo}>
        <div className={styles.containerTwoA}>
            <h1 className={styles.h1}>App Development</h1>
            <div>
                <p className={styles.p}>Full Stack Solutions Powered By The Cloud</p>
                <p className={styles.p}>Enhanced Capabilites Ulitizing AI</p>
        ...
        <div className={styles.containerTwoB}>
            <Paper      sx={{ p: '2px 4px', display: 'flex', flexDirection: 'column', height: '80%',  width: '100%', borderRadius: 0, overflowY:'scroll' }} >
